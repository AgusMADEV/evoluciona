...
// Enrutador del back de la aplicación que sirve los datos que se piden en función de la URL
    ...
    $conexion = new ConexionBD($bdservidor,$bdusuario,$bdcontrasena,$bdbasededatos);                   // Creo una nueva instancia de la conexion
    ...
    if(isset($_GET['envio'])){
        ...
        $archivo = '../modelodedatos/pedidos/'.date('U').'.json';
